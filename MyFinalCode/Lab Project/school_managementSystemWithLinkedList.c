...
void search(int rollnumber)
{
    ...
    printf("Student with roll number %d is not found in the management systems\n", rollnumber);
}
...
void display()
{
    ...
    while(temp!=NULL){
        ...
        printf("Name: %s\n", temp->name);
        printf("Phone: %s\n", temp->phone);
        printf("Percentage: %0.4f\n\n", temp->percentage); // waris 39% // ba 98 
        temp = temp->next;
...
int main()
{
    ...
    int rollnumber;
    float percentage;
    printf("Welcome to Waris School Management System\n");
    printf("1. Enter the Student Information\n2. Need Student Information?\n3. Delete the Student Information\n4. Update the Student Information\n5. Display all the Student Information\n");
